              ...
              <Box sx={{ padding: 1.5 }}>
                ...
                >
                  ...
                  >
                    ...
                    It involves technologies, processes, and practices designed to safeguard sensitive information.
                  </Typography>
                </motion.div>
                ...
                >
                  <Box sx={{ mt: 1, mb: 1 }}>
                    ...
                    >
                      ...
                      >
                        <Typography variant="caption" sx={{ color: darkMode ? '#ddd' : '#333', fontSize: '0.7rem' }}>
                          Introduction to Cybersecurity
                        </Typography>
                        <Typography variant="caption" sx={{ color: darkMode ? '#bbb' : '#555', fontSize: '0.7rem' }}>
                          YouTube
                        </Typography>
                      </Box>
                    </Box>
            ...
            <Collapse in={openImportance} timeout="auto" unmountOnExit>
              <Box sx={{ padding: 1.5 }}>
                ...
                >
                  ...
                  >
                    <li>Protecting personal and business data from unauthorized access.</li>
                    <li>Preventing financial losses due to cyber fraud.</li>
                    <li>Ensuring the security of critical infrastructure.</li>
                  </Typography>
                </motion.div>
              </Box>
            </Collapse>
